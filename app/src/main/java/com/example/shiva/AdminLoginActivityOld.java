...
public class AdminLoginActivityOld extends AppCompatActivity {
    ...
    private void validateLogin() {
        ...
        if (username.equals(ADMIN_USERNAME) && password.equals(ADMIN_PASSWORD)) {
            // Successful login
            Toast.makeText(AdminLoginActivityOld.this, "Login Successful", Toast.LENGTH_SHORT).show();

            // Start AdminHomeActivity on successful login
            Intent intent = new Intent(AdminLoginActivityOld.this, AdminHomeActivity.class);
            startActivity(intent);
            finish();
        } else {
            // Invalid credentials
            Toast.makeText(AdminLoginActivityOld.this, "Invalid username or password", Toast.LENGTH_SHORT).show();
        }
    }
}
